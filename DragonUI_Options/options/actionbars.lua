...
local function mainBarGroup()
    return { type='group', name = "Main Bar", order=1, args = {
        ...
        main_rows = { type='range', name="Rows", min=1, max=4, step=1, order=2.6,
            ...
            set=function(_,v) addon.db.profile.mainbars.player.rows=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        main_columns = { type='range', name="Columns", min=1, max=12, step=1, order=2.7,
            ...
            set=function(_,v) addon.db.profile.mainbars.player.columns=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        main_buttons_shown = { type='range', name="Buttons Shown", min=1, max=12, step=1, order=2.8,
            ...
            set=function(_,v) addon.db.profile.mainbars.player.buttons_shown=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        ...
        scale_actionbar2 = { type='range', name = "Scale", min=0.5, max=2.0, step=0.1, order=3.4,
            ...
            set=set('mainbars','scale_actionbar', nil, 'RefreshMainbarsDebounced') },
    }}
end
...
local function bottomLeftGroup()
    return { type='group', name = "Bottom Left", order=2, args = {
        ...
        bottom_left_rows2 = { type='range', name="Rows", min=1, max=4, step=1, order=2.6,
            ...
            set=function(_,v) addon.db.profile.mainbars.bottom_left.rows=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        bottom_left_columns2 = { type='range', name="Columns", min=1, max=12, step=1, order=2.7,
            ...
            set=function(_,v) addon.db.profile.mainbars.bottom_left.columns=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        bottom_left_buttons_shown2 = { type='range', name="Buttons Shown", min=1, max=12, step=1, order=2.8,
            ...
            set=function(_,v) addon.db.profile.mainbars.bottom_left.buttons_shown=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        scale_bottom_left2 = { type='range', name = "Scale", min=0.5, max=2.0, step=0.1, order=3.4,
            ...
            set=set('mainbars','scale_bottom_left', nil, 'RefreshMainbarsDebounced') },
    }}
end
...
local function bottomRightGroup()
    return { type='group', name = "Bottom Right", order=3, args = {
        ...
        bottom_right_rows2 = { type='range', name="Rows", min=1, max=4, step=1, order=2.6,
            ...
            set=function(_,v) addon.db.profile.mainbars.bottom_right.rows=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        bottom_right_columns2 = { type='range', name="Columns", min=1, max=12, step=1, order=2.7,
            ...
            set=function(_,v) addon.db.profile.mainbars.bottom_right.columns=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        bottom_right_buttons_shown2 = { type='range', name="Buttons Shown", min=1, max=12, step=1, order=2.8,
            ...
            set=function(_,v) addon.db.profile.mainbars.bottom_right.buttons_shown=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        scale_bottom_right2 = { type='range', name = "Scale", min=0.5, max=2.0, step=0.1, order=3.4,
            ...
            set=set('mainbars','scale_bottom_right', nil, 'RefreshMainbarsDebounced') },
    }}
end
...
local function rightGroup()
    return { type='group', name = "Right", order=4, args = {
        ...
        header_right_layout2 = { type='header', name = "Layout", order=2.5 },
        right_rows2 = { type='range', name="Rows", min=1, max=4, step=1, order=2.6,
            get=function() return addon.db.profile.mainbars.right.rows or 1 end,
            set=function(_,v) addon.db.profile.mainbars.right.rows=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        right_columns2 = { type='range', name="Columns", min=1, max=12, step=1, order=2.7,
            get=function() return addon.db.profile.mainbars.right.columns or 12 end,
            set=function(_,v) addon.db.profile.mainbars.right.columns=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        right_buttons_shown2 = { type='range', name="Buttons Shown", min=1, max=12, step=1, order=2.8,
            get=function() return addon.db.profile.mainbars.right.buttons_shown or 12 end,
            set=function(_,v) addon.db.profile.mainbars.right.buttons_shown=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        scale_rightbar2 = { type='range', name = "Scale", min=0.5, max=2.0, step=0.1, order=3.4,
            get=function() return addon.db.profile.mainbars.scale_rightbar end,
            set=set('mainbars','scale_rightbar', nil, 'RefreshMainbarsDebounced') },
    }}
end
...
local function right2Group()
    return { type='group', name = "Right 2", order=5, args = {
        ...
        right2_rows2 = { type='range', name="Rows", min=1, max=4, step=1, order=2.6,
            ...
            set=function(_,v) addon.db.profile.mainbars.left.rows=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        right2_columns2 = { type='range', name="Columns", min=1, max=12, step=1, order=2.7,
            ...
            set=function(_,v) addon.db.profile.mainbars.left.columns=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        right2_buttons_shown2 = { type='range', name="Buttons Shown", min=1, max=12, step=1, order=2.8,
            ...
            set=function(_,v) addon.db.profile.mainbars.left.buttons_shown=v; if addon.RefreshMainbarsDebounced then addon.RefreshMainbarsDebounced() elseif addon.RefreshMainbars then addon.RefreshMainbars() end end },
        scale_leftbar2 = { type='range', name = "Scale", min=0.5, max=2.0, step=0.1, order=3.4,
            ...
            set=set('mainbars','scale_leftbar', nil, 'RefreshMainbarsDebounced') },
    }}
end

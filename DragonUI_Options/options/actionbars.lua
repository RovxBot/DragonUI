...
local function rightGroup()
    return { type='group', name = "Right", order=4, args = {
        ...
        right_rows2 = { type='range', name="Rows", min=1, max=4, step=1, order=2.6,
            ...
            set=function(_,v) addon.db.profile.mainbars.right.rows=v; if addon.RefreshMainbars then addon.RefreshMainbars() end end },
        right_columns2 = { type='range', name="Columns", min=1, max=12, step=1, order=2.7,
            ...
            set=function(_,v) addon.db.profile.mainbars.right.columns=v; if addon.RefreshMainbars then addon.RefreshMainbars() end end },
        right_buttons_shown2 = { type='range', name="Buttons Shown", min=1, max=12, step=1, order=2.8,
            ...
            set=function(_,v) addon.db.profile.mainbars.right.buttons_shown=v; if addon.RefreshMainbars then addon.RefreshMainbars() end end },

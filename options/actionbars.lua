...
-- Helpers may not be initialised yet when this file loads; use dynamic wrappers
...
local function buttonsAppearanceGroup()
    return { type='group', name = "Button Appearance", inline = true, order = 2, args = {
        border_color = { type='color', name = "Border Color", order=10,
            get=function() local c=addon.db.profile.buttons.border_color; return c[1],c[2],c[3],c[4] end,
            set=colorSet('buttons','border_color','RefreshButtons'), hasAlpha=true },
        hotkey = { type='group', name = "Hotkey Text", inline=true, order=4, args = {
            ...
            color = { type='color', name = "Text Color", order=2, hasAlpha=true,
                get=function() local c=addon.db.profile.buttons.hotkey.color; return c[1],c[2],c[3],c[4] end,
        ...
        macros = { type='group', name = "Macro Text", inline=true, order=5, args = {
            ...
            color = { type='color', name = "Text Color", order=2, hasAlpha=true,
                get=function() local c=addon.db.profile.buttons.macros.color; return c[1],c[2],c[3],c[4] end,
        ...
        pages = { type='group', name = "Page Numbers", inline=true, order=6, args = {
            ...
            color = { type='color', name = "Text Color", order=2, hasAlpha=true,
                get=function() local c=addon.db.profile.buttons.pages.color; return c[1],c[2],c[3],c[4] end,
        ...
        cooldown = { type='group', name = "Cooldown Text", inline=true, order=7, args = {
            ...
            color = { type='color', name = "Text Color", desc="Cooldown text color", order=3, hasAlpha=true,
                get=function() local c=addon.db.profile.buttons.cooldown.color; return c[1],c[2],c[3],c[4] end,
        ...
        hotkey_shadow = { type='color', name = "Hotkey Shadow Color", order=10, hasAlpha=true,
            get=function() local c=addon.db.profile.buttons.hotkey.shadow; return c[1],c[2],c[3],c[4] end,
            set=colorSet('buttons','hotkey','shadow','RefreshButtons') },
    }}
end

function addon.BuildActionBarsOptions()
    return {
        ...
        args = {
            ...
            -- Keep legacy blocks hidden if still present elsewhere
            quicksetup = { type='group', name="Quick Setup", inline=true, hidden=true, order=0.1, args = {} },
            visibility = { type='group', name="Individual Bar Visibility", inline=true, hidden=true, order=0.5, args = {} },
            visibility_behavior = { type='group', name="Visibility Behavior", inline=true, hidden=true, order=0.7, args = {} },
        }
    }
end
